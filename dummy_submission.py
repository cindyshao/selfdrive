...
TEST_FILE_PATH='/media/ml/备份/ROB535_Perception/rob535-fall-2019-task-1-image-classification/data-2019/test'
...
def write_dummy_labels(test_file_path, output_path):
    ...
    files.sort()
    output_file = '{}/test_dummy_labels.csv'.format(output_path)
