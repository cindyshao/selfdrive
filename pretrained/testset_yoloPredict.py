...
def main():
    ...
    test_data = np.loadtxt('/Users/cindyshao/Dropbox/ME599/project/test_nolabels.csv', skiprows=1, dtype=str, delimiter=',')
    labels = test_data[:, 1].astype(np.uint8)
    files = test_data[:, 0]
    name = '{}/test_labels.csv'.format('/Users/cindyshao/Dropbox/ME599/project/')
...
def process(fname,net):
    ...
    dir = '/Users/cindyshao/Dropbox/ME599/project/rob535-fall-2019-task-1-image-classification/data-2019/test/'
    im_fname = dir + fname
